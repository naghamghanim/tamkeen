...
@section("title","Manage students-model Paging")
        ...
        <td scope="col">
            <form method="post" action='{{asset("students-model/".$item->id)}}'>
                ...
                <button onclick='return confirm("Are you sure????")' type="submit"
                    ...
                    <a href="{{route('students-model.delete',$item->id)}}" onclick='return confirm("Are you sure????")' class="btn btn-outline-danger">Delete</a>
            </form>
